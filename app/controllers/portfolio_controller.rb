class PortfolioController < ApplicationController
  ...
  def index
    @sections = [
      ...
      { title: "Headshots", blurb: "Make a lasting impression with my professional headshot photography services. Perfect for business profiles, social media, or personal branding, I ensure you look confident and approachable.", path: headshots_index_path, image_url: view_context.asset_path("anna.jpg") },
